...
function TryCreateLaravelCommand()
  ...
  then
    ...
    if vim.fn.exists(":Laravel") > 0 then
...
---
---It is recommended to not use this function directly, but instead do `config = true` in the lazy config which calls this function automatically.
function M.setup()
  HasLaravelCommand = false
